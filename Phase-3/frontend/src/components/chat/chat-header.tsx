      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-secondary-900 dark:text-white">TaskMaster AI</h1>
              <p className="text-xs text-secondary-500 dark:text-secondary-400">Your AI task assistant</p>
            </div>
          </div>
        </div>
        <button className="rounded-lg p-2 transition-colors hover:bg-secondary-100 dark:hover:bg-secondary-800">
